...
<head>
    <meta charset="UTF-8">
    <title>ATV Tour in Cusco </title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0, user-scalable=no">
    <meta name="keywords" content="ATV Tour in Cusco, Atv in the andes" />
    <meta name="description"
        content="We will visit the main touristic places of the Sacred Valley. We make our first stop at the church of Tiobamba" />
    <meta property="og:url" content="https://www.andeanexclusive.com/adventures/atv-tour">
    <meta property="og:title" content="ATV Tour in Cusco">
    <meta property="og:type" content="article">
    <meta name="twitter:card" content="summary_large_image">
    <meta property="og:image" content="https://andeanexclusive.com/img/tours/atv-cusco-tours-exclusive.jpg" />
    <meta name="author" content="Web Masters DJM2" />
    <link rel="canonical" href="https://www.andeanexclusive.com/adventures/atv-tour">
        ...
        <div class="row">
                ...
                <div class="sticky-top" style="padding-top: 75px; z-index: 40">
                    <div>
                        <div data-onepage-title="Services" data-onepage-slug="services"
                            ...
                            <div id="similares">
                                <div id="separador"></div>
                                <a href="choquequirao-tour" class="button">Choquequiro 4 days trekking</a>
                            </div>
                            <div id="similares">
                                <div id="separador"></div>
            ...
            <div class="col-lg-6">
                <div data-onepage-title="Services" style="text-align:justify" data-onepage-slug="services"
                    ...
                    <center>
                        <h1 id="titulo1"> ATV TOUR MARAS, MORAY</h1>
                        <div id="separadordjm2"></div>
                        <p class="text-center"><i class="fa fa-clock-o"></i> Full Day</p>
                        <p class="text-center"><i class="fa fa-map-marker"> Cusco - Maras - Moray</i>
                        </p>
                        <p class="text-center"><i class="fa fa-envelope"></i> Book 10 days in advance</p>
                    </center>
                    <div id="separador"></div>
                    <h5 style="padding: 0px 1px 0px 20px;">Itinerary:</h5>
                    <p style="padding: 0px 1px 0px 20px;">
                        The adventure will start from our base in<strong> Chinchero,</strong> approximately 40 minutes
                        from the city of
                        Cusco. We will visit the main touristic places of the<strong> Sacred Valley.</strong> We make
                        our first stop at
                        the church of Tiobamba, then we will visit the salt mines of Maras; finally we will visit Moray
                        - agricultural terraces of the Incas; this concludes our quad bike tour to Maras, Moray and the
                        Sacred Valley.
                    </p>
                    ...
                    <div class="tab-content pb-5" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                            ...
                            <ul>
                                ...
                                <li>Transportation from Cusco.</li>
                                <li>Base, gasoline, driving lessons, equipment
                                    (helmet, gloves, lenses).</li>
                                <li>Lunch at Salineras.</li>
                                <li>Sweet / snack en route.</li>
                                <li>Photos.</li>
                                <li>The entrances to the sites Maras and Salineras</li>
                            </ul>
                        </div>
                    ...
                    <iframe
                        src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2FAndeanExclusiveTours%2Fposts%2Fpfbid02bvkNAu3Z4A1h5vCLvk1F4ZCMRfssVUwb7kaAEfZEb81cpeJAmuBKEUmudvVtyaLul&show_text=true&width=500"
                        width="100%" height="879" style="border:none;overflow:hidden" scrolling="no"
                    ...
                    <div class="form text-center">
                        ...
                        <div class="fb-comments" data-href="https://andeanexclusive.com/adventures/atv-tour"
