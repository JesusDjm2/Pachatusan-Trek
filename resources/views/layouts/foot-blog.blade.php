<footer id="footer">
    <div class="container footer-container">
        <div class="row text-center">
            <div class='col-sm-6 col-md-4' style="padding-bottom: 35px">
            ...
            <div class='col-sm-6 col-md-4 footer-column-4' style="padding-bottom: 35px">
            ...
            <div class='col-sm-6 col-md-4 footer-column-4' style="padding-bottom: 35px">
                ...
                <div id="tt_sociallinkswidget-4" class="footer_widget widget widget_social">
                    <div class="social-links">
                        <a href="https://www.facebook.com/AndeanExclusiveTours" target="_blank" rel="nofollow"><i
                                class="fa fa-facebook fa-2x"></i></a>
                        <a href="https://twitter.com/AndeanExclusive" target="_blank" rel="nofollow"><i
