...
<head>
    <title>Pachatusan Trek - Travel Agency & Tour Operator for Perú</title>
...
<body>
        ...
        <div class="container">
            <div class="row v-center">
                    ...
                    <nav class="menu">
                        ...
                        <ul class="menu-main">
                            <li class="menu-item-has-children">
                                <a href="{{ route('treks') }}">Treks <i class="fa fa-angle-down"></i></a>
                                <div class="sub-menu mega-menu mega-menu-column-4">
                                    @foreach ($globalTreks as $tour)
                            ...
                            <li class="menu-item-has-children">
                                <a href="{{ route('expeditions') }}">Expeditions <i class="fa fa-angle-down"></i></a>
                                <div class="sub-menu mega-menu mega-menu-column-4">
                                    @foreach ($globalExpeditions as $tour)
                                        <div class="list-item text-center">
                                            <a href="{{ route('tour.show', $tour->slug) }}">
                                                <div style="width: 100%; overflow: hidden; height:110px">
                                                    <img src="{{ asset($tour->imgThumb) }}" alt="{{ $tour->nombre }}">
                            ...
                            <li class="menu-item-has-children">
                                <a href="{{ route('entours') }}">Tours <i class="fas fa-angle-down"></i></a>
                                <div class="sub-menu mega-menu mega-menu-column-4">
                                    @foreach ($globalTours as $tour)
                                        <div class="list-item text-center">
                                            <a href="{{ route('tour.show', $tour->slug) }}">
                                                <div style="width: 100%; overflow: hidden; height:110px">
                                                    <img src="{{ asset($tour->imgThumb) }}" alt="{{ $tour->nombre }}">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <div class="sub-menu single-column-menu">
                                    <ul class="mx-auto">
                                        ...
                                        <li><a href="{{ route('certificates') }}">Cartificates & Recognitions</a></li>
                                        <li><a href="{{ route('social') }}">Social Projects</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li>
                ...
                <div class="header-item item-right">
                    ...
                    <a href="{{ route('inicio') }}" class="translate-button">
                        <img src="{{ asset('img/espana.png ') }}" alt="Traducción al español Pachatusan" width="25px"
                            title="Traducción al español" style="margin-top: 2px; margin-left: 10px">
                    </a>
    ...
    <footer class="bg-dark text-white py-4">
                    ...
                    <div class="carousel-item active">
                        <div class="row justify-content-center">
                            <div class="col-md-1 col-2 mb-4">
                                <img src="{{ asset('img/aatc.png') }}" class="img-fluid" loading="lazy" alt="AATC">
                            </div>
                            <div class="col-md-1 col-4 mb-2">
                                <img src="{{ asset('img/aptae.png') }}" class="img-fluid" loading="lazy" alt="Aptae">
                            </div>
                            <div class="col-md-1 col-4 mb-2">
                                <img src="{{ asset('img/cartuc.png') }}" class="img-fluid" loading="lazy" alt="Cartuc">
                            </div>
                            <div class="col-md-1 col-4 mb-2">
                                <img src="{{ asset('img/codigoesssna.png') }}" class="img-fluid" loading="lazy" alt="Código ESSSNA">
                            </div>
                            <div class="col-md-1 col-4 mb-2">
                                <img src="{{ asset('img/GERCETUR.png') }}" class="img-fluid" loading="lazy" alt="GERCETUR">
                            </div>
                            <div class="col-md-1 col-4 mb-2">
                                <img src="{{ asset('img/marca-peru.png') }}" class="img-fluid" loading="lazy" alt="Marca Peru">
                            </div>
                            <div class="col-md-1 col-4 mb-2">
                                <img src="{{ asset('img/mincetur.png') }}" class="img-fluid" loading="lazy" alt="Mincetur">
                            </div>
                            <div class="col-md-1 col-4 mb-2">
                                <img src="{{ asset('img/pfp.png') }}" class="img-fluid" loading="lazy" alt="PFP">
                            </div>
                            <div class="col-md-1 col-4 mb-2">
                                <img src="{{ asset('img/sernanp.png') }}" class="img-fluid" loading="lazy" alt="Sernanp">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 socials pt-4">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h4>TOUR CERT:</h4>
                            <p> <img src="{{ asset('img/TourCert.png') }}" class="img-fluid" width="80px" loading="lazy" alt="Tour Cert"> </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 pt-4">
                    ...
                    <p class="text-justify" style="text-align: justify">
                        Pachatusan Trek is the award-winning luxury tour operator behind your South American experience.
        ...
        <div class="container pt-4" style="border-top:1px solid grey">
            <p class="text-center">
                &copy; {{ date('Y') }} All rights reserved | Pachatusan Trek | Made by
