    ...
    <div class="wrapper">
        ...
        <div class="blogContenedor">
            ...
            <div class="content-overlay">
                <h1>Blog con el Tag: {{ $tag->nombre }}</h1>
            </div>
        </div>
    </div>
        ...
        <div class="location">
            <div class="row text-center">
                ...
                <div class="col-lg-6 col-sm-12 text-center">
                    ...
                    <a href="{{ route('blog-es') }}">Blog</a> <span>⮞</span>
                    <a>{{ $tag->nombre }}</a>
                </div>
                <div class="col-lg-3 col-sm-2" id="display2">
                    <div style="width: 90%; height:1px; background:grey; margin-top:0.6em">
            ...
            <div class="col-lg-9">
                <div class="row">
                    @foreach ($blogs as $tour)
                        <div class="col-lg-6 relaciones" style="margin-bottom: 1.4em">
                            <div class="card" style="margin-bottom:1em;">
                                <a href="{{ route('esblog.show', $tour->slug) }}">
                                    <img class="card-img-top" src="{{ asset($tour->imgThumb) }}"
                                        alt="{{ $tour->nombre }}" loading="lazy"
                                        style="width: 100%; height:250px; objet-fit:cover">
                                </a>
