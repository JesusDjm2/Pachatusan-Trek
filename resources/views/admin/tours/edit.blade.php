                    ...
                    <form action="{{ route('tours.update', $tour->id) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mt-3">
                                <label for="descripcionCorta" class="form-label font-weight-bold">Descripción corta: <small
                            ...
                            <div class="col-lg-12 mt-3">
                                <label for="presentacion" class="form-label font-weight-bold">Contenido Inicial:</label>
                            ...
                            <div class="col-lg-12 mt-3">
                                <label for="itinerario" class="form-label font-weight-bold">Itinerario:</label>
                            ...
                            <div class="col-lg-6 mt-3">
                                <label for="incluye" class="form-label font-weight-bold">Incluye:</label>
                            ...
                            <div class="col-lg-12 mt-3">
                                <label for="galeria" class="font-weight-bold">Galería de imágenes:</label>
                                <input type="file" class="form-control form-control-sm" name="galeria[]"
                                    id="galeria" multiple>
                                        ...
                                        <div class="row">
                                            @foreach (explode(',', $tour->galeria) as $imagen)
                                                <div class="col-3 mb-3">
                                                    <img src="{{ asset($imagen) }}" alt="Imagen actual"
                                                        class="img-thumbnail"
                                    ...
                                    @foreach ($categorias as $id => $nombre)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox"
                                                id="categoria{{ $id }}" name="categorias[]"
                                                value="{{ $id }}"
                            ...
                            <div class="col-lg-12 mt-3">
                                <label for="keywords" class="form-label font-weight-bold">Keywords: <small
                                        class="text-success">(Separar cada
