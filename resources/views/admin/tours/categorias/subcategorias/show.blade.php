...
@section('contenido')
    ...
    @php
        if (Str::contains(Str::lower($subcategoria->nombre), 'north')) {
            $bannerClass = 'banner-north';
        } elseif (Str::contains(Str::lower($subcategoria->nombre), 'inca')) {
            $bannerClass = 'banner-inca';
        } elseif (Str::contains(Str::lower($subcategoria->nombre), 'sacred')) {
