                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h1 class="fw-bold text-primary mb-1 display-6">
                            Tours <small class="text-muted">(EN)</small>
                        </h1>
                        <p class="text-muted mb-0">
                            <i class="fas fa-globe-americas me-1"></i>
                            Gestión de tours en inglés
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 text-md-end mt-3 mt-md-0 d-flex justify-content-md-end gap-2">
                <a href="{{ route('tours.create') }}" class="btn btn-primary shadow-sm hover-up">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h5 class="mb-0 text-primary fw-bold">
                            <i class="fas fa-list me-2"></i>Listado de Tours
                        </h5>
                    </div>
                            ...
                            @foreach ($tours as $tour)
                                <tr>
                                    <td class="px-4 nombre">
                                        <div class="fw-bold text-dark">{{ $tour->nombre }}</div>
                                    ...
                                    <td class="px-4 text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{ route('tour.show', $tour->slug) }}" class="btn btn-sm btn-outline-primary" title="Ver" target="_blank">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a href="{{ route('tours.edit', $tour->id) }}" class="btn btn-sm btn-info text-white" title="Editar">
