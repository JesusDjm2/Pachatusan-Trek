                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            ...
                            Gestión de países para tours en inglés
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 text-md-end mt-3 mt-md-0">
                <a href="{{ route('countries.create') }}" class="btn btn-primary shadow-sm">
                                    ...
                                    @forelse ($paises as $pais)
                                        <tr>
                                            ...
                                            <td class="px-4 py-3 text-center">
                                                <a href="{{ route('public.country.show', $pais->slug ?? $pais->id) }}"
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ route('countries.edit', $pais) }}"
                                                        class="btn btn-sm btn-warning" data-bs-toggle="tooltip"
                                                        title="Editar país">
                                                        <i class="fas fa-edit me-1"></i> Editar
                                                    </a>

                                                    <form action="{{ route('countries.destroy', $pais) }}" method="POST"
                                                        class="d-inline"
