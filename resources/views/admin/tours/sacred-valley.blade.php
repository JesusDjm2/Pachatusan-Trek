...
@section('metas')
    <title>Cusco & Sacred Valley of the Incas</title>
    <meta name="keywords" content="Cusco & Sacred Valley of the Incas" />
    <meta name="description" content="Cusco & Sacred Valley of the Incas" />
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Cusco & Sacred Valley of the Incas">
...
@section('contenido')
    ...
    <section class="banner-sacred">
        <div class="banner-content container">
            <h1>Cusco & Sacred Valley of the Incas</h1>
