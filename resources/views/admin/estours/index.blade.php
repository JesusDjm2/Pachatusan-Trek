...
@section('contenido')
    <div class="container-fluid py-4">
        @include('partials.admin.page-header', [
            ...
            'title' => 'Tours',
            'badge' => 'ES',
            'subtitle' => 'Gestión de tours en español',
            'actions' => '<a href="' . route('estours.create') . '" class="btn btn-primary shadow-sm hover-up"><i class="fas fa-plus-circle me-1"></i> Nuevo Tour</a>',
        ])
