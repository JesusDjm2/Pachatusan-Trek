...
@section('metas')
<meta name="description" content="{{ $meta_description ?? 'Premium Camping Equipment – Glamping in the Andes | Pachatusantrek' }}">
...
<section class="banner-glamping">
    <div class="banner-content container">
        ...
        <p>Deluxe Service — Luxury in the Heart of the Andes</p>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        <img src="{{ asset('img/glamping/comedor-1.webp') }}"
                             alt="Dining setup in the Andes" class="img-glamping">
                    </div>
                    <div class="col-6">
    ...
    <div class="container">
        ...
        <div class="row align-items-center g-5 mb-5">
            ...
            <div class="col-lg-7">
                <div class="row g-3">
                    <div class="col-12">
                        <div class="img-placeholder img-placeholder-tall">[ Luxury bed inside tent — hotel-quality linen ]</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <img src="{{ asset('img/glamping/carpa-de-banio-1.webp') }}"
                             alt="Bathroom tent setup" class="img-glamping">
                    </div>
                    <div class="col-6">
                        <img src="{{ asset('img/glamping/carpa-de-banio-2.webp') }}"
                             alt="Portable ecological toilet" class="img-glamping">
                    </div>
                    <div class="col-12">
                        <img src="{{ asset('img/glamping/carpa-de-banio-3.webp') }}"
                             alt="Bathroom tent interior" class="img-glamping">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-7">
                <div class="row g-3">
                    <div class="col-6">
                        <img src="{{ asset('img/glamping/comedor-1.webp') }}"
                             alt="Dining tent exterior" class="img-glamping">
                    </div>
                    <div class="col-6">
                        <img src="{{ asset('img/glamping/comedor-2.webp') }}"
                             alt="Breakfast in the mountains" class="img-glamping">
                    </div>
                    <div class="col-12">
                        <img src="{{ asset('img/glamping/comedor-3.webp') }}"
                             alt="Dining setup with tableware" class="img-glamping">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <img src="{{ asset('img/glamping/campamento-glamping.webp') }}"
                             alt="Pachatusantrek campsite" class="img-glamping">
                    </div>
                    <div class="col-6">
                        <img src="{{ asset('img/glamping/foto01.webp') }}"
                             alt="Field staff on the Inca Trail" class="img-glamping">
                    </div>
                    <div class="col-12">
                        <img src="{{ asset('img/glamping/campamento-01.png') }}"
                             alt="Full team at camp" class="img-glamping">
                    </div>
                </div>
            </div>
        </div>
...
<section class="glamp-section">
    <div class="container">
        ...
        <div class="glamp-quote rounded-4 mt-5">
            ...
            <small style="opacity:.75;">— With the protection of Pachamama and the permission of the Apus</small></p>
        </div>
    </div>
</section>
